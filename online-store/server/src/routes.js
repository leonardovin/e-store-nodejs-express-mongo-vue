...
module.exports = (app) => {
  ...
  //post products
  app.post("/products", prodController.post);
  //get products
  ...
  //get a product
  app.get("/products/:id", prodController.show);
  //get products by category
  app.get("/products/category/:category", prodController.indexByCat);
  //add product to a cart
  app.put("/cart/:id", prodController.putInCart);
};
